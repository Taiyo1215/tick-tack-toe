...
# 工夫点
* ミニマックスアルゴリズムを使ったコンピュータプレイヤーの実装
* コンピュータが最適な手を選ぶようにする
...
[![MSBuild](https://github.com/Taiyo1215/tick-tack-toe/actions/workflows/msbuild.yml/badge.svg)](https://github.com/Taiyo1215/tick-tack-toe/actions/workflows/msbuild.yml)
